...
| $\color{green}\text{64  }$ | $\color{green}\text{A Haunting in Venice}$ | $\color{green}\text{1527.0}$ |
...
| $\color{red}\text{135 }$ | $\color{red}\text{Knight and Day}$ | $\color{red}\text{1433.4}$ |
...
| $\color{red}\text{152 }$ | $\color{red}\text{Independence Day}$ | $\color{red}\text{1387.1}$ |
