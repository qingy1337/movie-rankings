...
| $\color{green}\text{93  }$ | $\color{green}\text{Rainman}$ | $\color{green}\text{1486.2}$ |
| $\color{red}\text{94  }$ | $\color{red}\text{Ip Man}$ | $\color{red}\text{1484.2}$ |
| $\color{red}\text{95  }$ | $\color{red}\text{Wrath of Man}$ | $\color{red}\text{1478.1}$ |
