...
| $\color{red}\text{15  }$ | $\color{red}\text{Life of Pi}$ | $\color{red}\text{1595.1}$ |
...
| $\color{green}\text{40  }$ | $\color{green}\text{Captain America: The Winter Soldier}$ | $\color{green}\text{1558.4}$ |
