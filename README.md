...
| $\color{black}\text{2   }$ | $\color{black}\text{Squid Game}$ | $\color{black}\text{1616.5}$ |
...
| $\color{green}\text{19  }$ | $\color{green}\text{Star Wars}$ | $\color{green}\text{1587.2}$ |
...
| $\color{green}\text{34  }$ | $\color{green}\text{Doctor Strange}$ | $\color{green}\text{1563.3}$ |
...
| $\color{red}\text{104 }$ | $\color{red}\text{Frequency}$ | $\color{red}\text{1479.1}$ |
...
| $\color{green}\text{145 }$ | $\color{green}\text{Crouching Tiger Hidden Dragon}$ | $\color{green}\text{1428.3}$ |
