...
| Rank | Movie                  | Rating |
|------|------------------------|--------|
| $\color{green}\text{1   }$ | $\color{green}\text{Squid Game}$ | $\color{green}\text{1632.7}$ |
...
| $\color{black}\text{4   }$ | $\color{black}\text{Interstellar}$ | $\color{black}\text{1611.4}$ |
...
| $\color{black}\text{23  }$ | $\color{black}\text{The Hobbit}$ | $\color{black}\text{1585.3}$ |
| $\color{black}\text{24  }$ | $\color{black}\text{Avengers: Infinity War}$ | $\color{black}\text{1579.4}$ |
| $\color{black}\text{25  }$ | $\color{black}\text{No Country for Old Men}$ | $\color{black}\text{1578.9}$ |
| $\color{green}\text{26  }$ | $\color{green}\text{Loki}$ | $\color{green}\text{1576.3}$ |
...
| $\color{black}\text{29  }$ | $\color{black}\text{The Menu}$ | $\color{black}\text{1573.5}$ |
| $\color{black}\text{30  }$ | $\color{black}\text{Vagabond}$ | $\color{black}\text{1571.6}$ |
| $\color{black}\text{31  }$ | $\color{black}\text{X-Files}$ | $\color{black}\text{1571.5}$ |
| $\color{black}\text{32  }$ | $\color{black}\text{Black Panther}$ | $\color{black}\text{1571.4}$ |
| $\color{black}\text{33  }$ | $\color{black}\text{The Avengers}$ | $\color{black}\text{1569.9}$ |
| $\color{black}\text{34  }$ | $\color{black}\text{Doctor Strange}$ | $\color{black}\text{1568.6}$ |
| $\color{black}\text{35  }$ | $\color{black}\text{Tenet}$ | $\color{black}\text{1567.4}$ |
| $\color{black}\text{36  }$ | $\color{black}\text{A Quiet Place}$ | $\color{black}\text{1565.8}$ |
...
| $\color{black}\text{39  }$ | $\color{black}\text{Scream VI}$ | $\color{black}\text{1560.8}$ |
...
| $\color{green}\text{61  }$ | $\color{green}\text{The Man Who Knew Infinity}$ | $\color{green}\text{1534.0}$ |
| $\color{black}\text{62  }$ | $\color{black}\text{Mission Impossible: Dead Reckoning P1}$ | $\color{black}\text{1532.6}$ |
| $\color{red}\text{63  }$ | $\color{red}\text{The Maze Runner: The Scorch Trials}$ | $\color{red}\text{1528.9}$ |
...
| $\color{red}\text{66  }$ | $\color{red}\text{Top Gun: Maverick}$ | $\color{red}\text{1525.1}$ |
...
| $\color{green}\text{73  }$ | $\color{green}\text{Locke and Key}$ | $\color{green}\text{1518.4}$ |
...
| $\color{green}\text{80  }$ | $\color{green}\text{The Spy Next Door}$ | $\color{green}\text{1505.9}$ |
| $\color{black}\text{81  }$ | $\color{black}\text{Iron Chef}$ | $\color{black}\text{1505.8}$ |
| $\color{black}\text{82  }$ | $\color{black}\text{Top Gun}$ | $\color{black}\text{1501.0}$ |
...
| $\color{black}\text{87  }$ | $\color{black}\text{Mission Impossible 3}$ | $\color{black}\text{1499.2}$ |
...
| $\color{black}\text{110 }$ | $\color{black}\text{John Wick}$ | $\color{black}\text{1467.6}$ |
| $\color{black}\text{111 }$ | $\color{black}\text{The Man in the Iron Mask}$ | $\color{black}\text{1466.7}$ |
| $\color{black}\text{112 }$ | $\color{black}\text{Peter the Rabbit}$ | $\color{black}\text{1466.7}$ |
| $\color{red}\text{113 }$ | $\color{red}\text{World War Z}$ | $\color{red}\text{1463.6}$ |
...
| $\color{black}\text{123 }$ | $\color{black}\text{American Sniper}$ | $\color{black}\text{1453.7}$ |
| $\color{black}\text{124 }$ | $\color{black}\text{Pompeii}$ | $\color{black}\text{1453.5}$ |
| $\color{black}\text{125 }$ | $\color{black}\text{Cars 2}$ | $\color{black}\text{1453.3}$ |
...
| $\color{red}\text{128 }$ | $\color{red}\text{Knight and Day}$ | $\color{red}\text{1450.9}$ |
...
| $\color{black}\text{135 }$ | $\color{black}\text{Avatar: The Last Airbender}$ | $\color{black}\text{1445.7}$ |
...
| $\color{black}\text{149 }$ | $\color{black}\text{Crouching Tiger Hidden Dragon}$ | $\color{black}\text{1420.9}$ |
...
| $\color{red}\text{165 }$ | $\color{red}\text{The Silence}$ | $\color{red}\text{1399.9}$ |
