...
| $\color{black}\text{18  }$ | $\color{black}\text{Life}$ | $\color{black}\text{1540.3}$ |
| $\color{red}\text{19  }$ | $\color{red}\text{Iron Man}$ | $\color{red}\text{1540.2}$ |
| $\color{green}\text{20  }$ | $\color{green}\text{Star Wars}$ | $\color{green}\text{1540.2}$ |
