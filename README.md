...
| $\color{green}\text{137 }$ | $\color{green}\text{The Matrix Reloaded}$ | $\color{green}\text{1449.6}$ |
...
| $\color{black}\text{165 }$ | $\color{black}\text{Jurassic World: Dominion}$ | $\color{black}\text{1416.5}$ |
