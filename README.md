...
| $\color{black}\text{42  }$ | $\color{black}\text{Avengers: Infinity War}$ | $\color{black}\text{1545.2}$ |
...
| $\color{red}\text{79  }$ | $\color{red}\text{The Day After Tomorrow}$ | $\color{red}\text{1509.5}$ |
