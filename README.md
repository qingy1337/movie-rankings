...
| $\color{green}\text{58  }$ | $\color{green}\text{Mission Impossible: Fallout}$ | $\color{green}\text{1530.0}$ |
| $\color{black}\text{59  }$ | $\color{black}\text{Captain America: Civil War}$ | $\color{black}\text{1527.1}$ |
