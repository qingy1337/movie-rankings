...
| $\color{green}\text{107 }$ | $\color{green}\text{Wrath of Man}$ | $\color{green}\text{1473.6}$ |
...
| $\color{red}\text{114 }$ | $\color{red}\text{Cars 3}$ | $\color{red}\text{1460.5}$ |
...
| $\color{red}\text{130 }$ | $\color{red}\text{Pompeii}$ | $\color{red}\text{1450.4}$ |
