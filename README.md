...
| $\color{black}\text{2   }$ | $\color{black}\text{The Maze Runner: The Death Cure}$ | $\color{black}\text{1591.0}$ |
...
| $\color{black}\text{7   }$ | $\color{black}\text{Ant-Man}$ | $\color{black}\text{1582.2}$ |
| $\color{black}\text{8   }$ | $\color{black}\text{Life of Pi}$ | $\color{black}\text{1580.0}$ |
| $\color{green}\text{9   }$ | $\color{green}\text{The Mandalorian}$ | $\color{green}\text{1579.1}$ |
| $\color{black}\text{10  }$ | $\color{black}\text{Thirteen Lives}$ | $\color{black}\text{1577.5}$ |
| $\color{black}\text{11  }$ | $\color{black}\text{Avengers: Endgame}$ | $\color{black}\text{1577.0}$ |
| $\color{black}\text{12  }$ | $\color{black}\text{Maleficent}$ | $\color{black}\text{1576.5}$ |
...
| $\color{black}\text{23  }$ | $\color{black}\text{The Wild Robot}$ | $\color{black}\text{1557.0}$ |
| $\color{black}\text{24  }$ | $\color{black}\text{X-Men}$ | $\color{black}\text{1555.4}$ |
| $\color{black}\text{25  }$ | $\color{black}\text{A Quiet Place}$ | $\color{black}\text{1554.8}$ |
| $\color{black}\text{26  }$ | $\color{black}\text{Black Panther}$ | $\color{black}\text{1554.3}$ |
| $\color{green}\text{27  }$ | $\color{green}\text{The Prestige}$ | $\color{green}\text{1554.2}$ |
| $\color{red}\text{28  }$ | $\color{red}\text{Scream V}$ | $\color{red}\text{1553.9}$ |
| $\color{black}\text{29  }$ | $\color{black}\text{Train to Busan}$ | $\color{black}\text{1551.3}$ |
| $\color{black}\text{30  }$ | $\color{black}\text{The Hunger Games}$ | $\color{black}\text{1550.9}$ |
| $\color{black}\text{31  }$ | $\color{black}\text{Vagabond}$ | $\color{black}\text{1550.6}$ |
| $\color{black}\text{32  }$ | $\color{black}\text{Avatar 2}$ | $\color{black}\text{1549.9}$ |
| $\color{black}\text{33  }$ | $\color{black}\text{Passengers}$ | $\color{black}\text{1549.6}$ |
...
| $\color{green}\text{45  }$ | $\color{green}\text{Scream VI}$ | $\color{green}\text{1536.7}$ |
...
| $\color{black}\text{49  }$ | $\color{black}\text{Mission Impossible: Ghost Protocol}$ | $\color{black}\text{1530.1}$ |
| $\color{black}\text{50  }$ | $\color{black}\text{Loki}$ | $\color{black}\text{1529.7}$ |
| $\color{black}\text{51  }$ | $\color{black}\text{Catch Me If You Can}$ | $\color{black}\text{1529.7}$ |
| $\color{black}\text{52  }$ | $\color{black}\text{Avengers: Infinity War}$ | $\color{black}\text{1529.3}$ |
| $\color{black}\text{53  }$ | $\color{black}\text{Lord of the Rings}$ | $\color{black}\text{1526.2}$ |
| $\color{black}\text{54  }$ | $\color{black}\text{Jack Reacher}$ | $\color{black}\text{1525.9}$ |
| $\color{black}\text{55  }$ | $\color{black}\text{The Young and Prodigious T.S. Spivet}$ | $\color{black}\text{1523.8}$ |
| $\color{black}\text{56  }$ | $\color{black}\text{Titanic}$ | $\color{black}\text{1523.6}$ |
| $\color{black}\text{57  }$ | $\color{black}\text{The Day After Tomorrow}$ | $\color{black}\text{1522.8}$ |
...
| $\color{black}\text{62  }$ | $\color{black}\text{A Haunting in Venice}$ | $\color{black}\text{1517.8}$ |
...
| $\color{black}\text{65  }$ | $\color{black}\text{Top Gun: Maverick}$ | $\color{black}\text{1516.6}$ |
...
| $\color{black}\text{73  }$ | $\color{black}\text{Star Trek: Picard}$ | $\color{black}\text{1511.4}$ |
...
| $\color{black}\text{81  }$ | $\color{black}\text{Zootopia}$ | $\color{black}\text{1508.8}$ |
...
| $\color{black}\text{109 }$ | $\color{black}\text{Red Notice}$ | $\color{black}\text{1476.5}$ |
| $\color{black}\text{110 }$ | $\color{black}\text{Mission Impossible 1}$ | $\color{black}\text{1476.2}$ |
| $\color{black}\text{111 }$ | $\color{black}\text{M3GAN}$ | $\color{black}\text{1475.7}$ |
| $\color{green}\text{112 }$ | $\color{green}\text{The Man in the Iron Mask}$ | $\color{green}\text{1475.6}$ |
...
| $\color{red}\text{120 }$ | $\color{red}\text{Pompeii}$ | $\color{red}\text{1472.0}$ |
...
| $\color{green}\text{124 }$ | $\color{green}\text{Journey 2: The Mysterious Island}$ | $\color{green}\text{1467.4}$ |
...
| $\color{black}\text{128 }$ | $\color{black}\text{Terminator}$ | $\color{black}\text{1460.8}$ |
...
| $\color{black}\text{132 }$ | $\color{black}\text{Unbreakable}$ | $\color{black}\text{1456.3}$ |
| $\color{black}\text{133 }$ | $\color{black}\text{When a Stranger Calls}$ | $\color{black}\text{1456.2}$ |
...
| $\color{red}\text{138 }$ | $\color{red}\text{Saving Private Ryan}$ | $\color{red}\text{1450.1}$ |
| $\color{red}\text{139 }$ | $\color{red}\text{Ninja Turtles}$ | $\color{red}\text{1449.0}$ |
| $\color{green}\text{140 }$ | $\color{green}\text{Everything, everywhere, all at once}$ | $\color{green}\text{1448.7}$ |
...
| $\color{black}\text{152 }$ | $\color{black}\text{All Quiet on The Western Front}$ | $\color{black}\text{1440.8}$ |
