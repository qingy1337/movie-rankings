...
| $\color{green}\text{2   }$ | $\color{green}\text{Squid Game}$ | $\color{green}\text{1595.8}$ |
...
| $\color{black}\text{41  }$ | $\color{black}\text{The Menu}$ | $\color{black}\text{1543.1}$ |
...
| $\color{black}\text{66  }$ | $\color{black}\text{The Terminal List}$ | $\color{black}\text{1520.0}$ |
| $\color{black}\text{67  }$ | $\color{black}\text{The Maze Runner: The Scorch Trials}$ | $\color{black}\text{1517.9}$ |
| $\color{black}\text{68  }$ | $\color{black}\text{Avatar}$ | $\color{black}\text{1516.2}$ |
| $\color{black}\text{69  }$ | $\color{black}\text{The Illusionist}$ | $\color{black}\text{1515.8}$ |
...
| $\color{black}\text{121 }$ | $\color{black}\text{Jack Reacher: Never Go Back}$ | $\color{black}\text{1468.1}$ |
| $\color{black}\text{122 }$ | $\color{black}\text{Rainman}$ | $\color{black}\text{1468.1}$ |
| $\color{red}\text{123 }$ | $\color{red}\text{Rango}$ | $\color{red}\text{1466.1}$ |
...
| $\color{red}\text{132 }$ | $\color{red}\text{Mission Impossible 2}$ | $\color{red}\text{1454.8}$ |
...
| $\color{black}\text{138 }$ | $\color{black}\text{Ninja Turtles}$ | $\color{black}\text{1449.0}$ |
| $\color{black}\text{139 }$ | $\color{black}\text{Rampage}$ | $\color{black}\text{1448.6}$ |
| $\color{black}\text{140 }$ | $\color{black}\text{American Made}$ | $\color{black}\text{1448.3}$ |
| $\color{black}\text{141 }$ | $\color{black}\text{Avatar: The Last Airbender}$ | $\color{black}\text{1448.3}$ |
| $\color{black}\text{142 }$ | $\color{black}\text{twilight}$ | $\color{black}\text{1447.3}$ |
