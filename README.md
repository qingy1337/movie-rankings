...
| $\color{green}\text{39  }$ | $\color{green}\text{Captain America: The Winter Soldier}$ | $\color{green}\text{1558.4}$ |
| $\color{black}\text{40  }$ | $\color{black}\text{Scream VI}$ | $\color{black}\text{1557.8}$ |
