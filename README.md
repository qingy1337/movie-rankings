...
| $\color{green}\text{38  }$ | $\color{green}\text{Captain America: The Winter Soldier}$ | $\color{green}\text{1542.4}$ |
...
| $\color{black}\text{79  }$ | $\color{black}\text{Cars 2}$ | $\color{black}\text{1510.3}$ |
