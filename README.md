...
| $\color{green}\text{21  }$ | $\color{green}\text{The Menu}$ | $\color{green}\text{1577.3}$ |
| $\color{black}\text{22  }$ | $\color{black}\text{The Prestige}$ | $\color{black}\text{1576.6}$ |
| $\color{black}\text{23  }$ | $\color{black}\text{The Hobbit}$ | $\color{black}\text{1575.5}$ |
...
| $\color{black}\text{29  }$ | $\color{black}\text{Vagabond}$ | $\color{black}\text{1567.6}$ |
...
| $\color{black}\text{64  }$ | $\color{black}\text{Titanic}$ | $\color{black}\text{1526.5}$ |
...
| $\color{black}\text{69  }$ | $\color{black}\text{Locke and Key}$ | $\color{black}\text{1518.3}$ |
...
| $\color{red}\text{75  }$ | $\color{red}\text{Guy Ritchie’s The Covenant}$ | $\color{red}\text{1514.1}$ |
...
| $\color{green}\text{119 }$ | $\color{green}\text{American Made}$ | $\color{green}\text{1460.4}$ |
...
| $\color{black}\text{129 }$ | $\color{black}\text{Peter the Rabbit}$ | $\color{black}\text{1455.4}$ |
...
| $\color{red}\text{149 }$ | $\color{red}\text{Journey 2: The Mysterious Island}$ | $\color{red}\text{1425.6}$ |
| $\color{black}\text{150 }$ | $\color{black}\text{Everything, everywhere, all at once}$ | $\color{black}\text{1425.1}$ |
| $\color{black}\text{151 }$ | $\color{black}\text{Horton hears a Who}$ | $\color{black}\text{1423.0}$ |
| $\color{black}\text{152 }$ | $\color{black}\text{Spooky Buddies}$ | $\color{black}\text{1422.0}$ |
| $\color{black}\text{153 }$ | $\color{black}\text{Crouching Tiger Hidden Dragon}$ | $\color{black}\text{1420.6}$ |
...
| $\color{red}\text{158 }$ | $\color{red}\text{War Horse}$ | $\color{red}\text{1409.5}$ |
...
| $\color{black}\text{167 }$ | $\color{black}\text{twilight}$ | $\color{black}\text{1398.7}$ |
...
| $\color{black}\text{170 }$ | $\color{black}\text{Shadow}$ | $\color{black}\text{1395.9}$ |
| $\color{black}\text{171 }$ | $\color{black}\text{Jurassic World: Dominion}$ | $\color{black}\text{1394.8}$ |
