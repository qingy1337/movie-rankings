...
| $\color{red}\text{34  }$ | $\color{red}\text{Scream V}$ | $\color{red}\text{1558.5}$ |
...
| $\color{green}\text{107 }$ | $\color{green}\text{The Curious Case of Benjamin Button}$ | $\color{green}\text{1476.1}$ |
