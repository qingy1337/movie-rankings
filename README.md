...
| $\color{black}\text{10  }$ | $\color{black}\text{Iron Man}$ | $\color{black}\text{1590.1}$ |
...
| $\color{black}\text{123 }$ | $\color{black}\text{A.I. Artificial Intelligence}$ | $\color{black}\text{1458.7}$ |
