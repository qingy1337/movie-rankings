...
| $\color{green}\text{25  }$ | $\color{green}\text{Vagabond}$ | $\color{green}\text{1563.4}$ |
...
| $\color{black}\text{28  }$ | $\color{black}\text{Avatar 2}$ | $\color{black}\text{1559.6}$ |
...
| $\color{black}\text{47  }$ | $\color{black}\text{Loki}$ | $\color{black}\text{1537.6}$ |
...
| $\color{green}\text{55  }$ | $\color{green}\text{Mission Impossible: Ghost Protocol}$ | $\color{green}\text{1530.0}$ |
| $\color{black}\text{56  }$ | $\color{black}\text{The Terminal List}$ | $\color{black}\text{1529.8}$ |
...
| $\color{black}\text{59  }$ | $\color{black}\text{Guy Ritchie’s The Covenant}$ | $\color{black}\text{1527.2}$ |
...
| $\color{black}\text{62  }$ | $\color{black}\text{Mission Impossible: Rogue Nation}$ | $\color{black}\text{1523.6}$ |
...
| $\color{black}\text{65  }$ | $\color{black}\text{Catch Me If You Can}$ | $\color{black}\text{1518.9}$ |
...
| $\color{black}\text{68  }$ | $\color{black}\text{Captain America: Civil War}$ | $\color{black}\text{1516.2}$ |
...
| $\color{black}\text{88  }$ | $\color{black}\text{Mission Impossible 3}$ | $\color{black}\text{1499.3}$ |
...
| $\color{black}\text{99  }$ | $\color{black}\text{Total Recall}$ | $\color{black}\text{1487.0}$ |
...
| $\color{black}\text{123 }$ | $\color{black}\text{Jack Reacher: Never Go Back}$ | $\color{black}\text{1464.0}$ |
| $\color{black}\text{124 }$ | $\color{black}\text{Drunken Master}$ | $\color{black}\text{1463.5}$ |
| $\color{red}\text{125 }$ | $\color{red}\text{Cars 3}$ | $\color{red}\text{1460.1}$ |
| $\color{black}\text{126 }$ | $\color{black}\text{Knight and Day}$ | $\color{black}\text{1459.2}$ |
...
| $\color{black}\text{133 }$ | $\color{black}\text{Rango}$ | $\color{black}\text{1454.0}$ |
| $\color{black}\text{134 }$ | $\color{black}\text{Avatar: The Last Airbender}$ | $\color{black}\text{1453.8}$ |
| $\color{red}\text{135 }$ | $\color{red}\text{When a Stranger Calls}$ | $\color{red}\text{1453.8}$ |
...
| $\color{red}\text{140 }$ | $\color{red}\text{Journey 2: The Mysterious Island}$ | $\color{red}\text{1444.2}$ |
...
| $\color{black}\text{151 }$ | $\color{black}\text{Ninja Turtles}$ | $\color{black}\text{1437.0}$ |
