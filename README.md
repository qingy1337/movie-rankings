...
| $\color{green}\text{50  }$ | $\color{green}\text{Loki}$ | $\color{green}\text{1529.7}$ |
...
| $\color{black}\text{63  }$ | $\color{black}\text{The Young and Prodigious T.S. Spivet}$ | $\color{black}\text{1518.3}$ |
